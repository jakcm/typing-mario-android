...
- 结论：**PASS**
- Git：`26a859f` (dirty)
- Flutter：`Flutter 3.44.6 • channel stable • https://github.com/flutter/flutter.git Framework • revision ee80f08bbf (8 days ago) • 2026-07-08 15:02:06 -0700 Engine • hash d3a3293399556a85388faf8c6f0723a7a5597aa8 (revision 83675ed276) (16 days ago) • 2026-06-30 16:59:03.000Z Tools • Dart 3.12.2 • DevTools 2.57.0 `
- Dart：`3.12.2`
- 平台：`macos Version 26.2 (Build 25C56)`
- 命令：`flutter test tool/stress_700.dart`
...
| 预热后 RSS | 155.09 MiB | 信息 | INFO |
| 结束 RSS | 163.52 MiB | 信息 | INFO |
| 峰值 RSS | 166.52 MiB | 信息 | INFO |
| 预热后 RSS 增长 | 8.42 MiB | <=96.00 MiB | PASS |
| wall time | 0.208s | <=30.0s | PASS |
