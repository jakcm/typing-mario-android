...
- 命令：`flutter test tool/stress_700.dart -- /Users/admin/projects/typing_mario_android/reports/stress/20260717T072930Z`
...
| 模拟时间 | 42.24s | 信息 | INFO |
| 最大 activeTargets | 44 | <=20 | FAIL |
| 最大 detached tracked | 0 | <=0 | PASS |
| 最大组件总数 | 54 | <=60 | PASS |
| drain 后 active/letters | 0/0 | 0/0 | PASS |
| pending events | 0 | 0 | PASS |
| 预热后 RSS | 154.98 MiB | 信息 | INFO |
| 结束 RSS | 163.41 MiB | 信息 | INFO |
| 峰值 RSS | 165.63 MiB | 信息 | INFO |
| 预热后 RSS 增长 | 8.42 MiB | <=96.00 MiB | PASS |
| wall time | 0.338s | <=30.0s | PASS |
