...
- 命令：`flutter test tool/stress_700.dart -- /Users/admin/projects/typing_mario_android/reports/stress/audio-priority-v2-final`
...
| 预热后 RSS | 155.33 MiB | 信息 | INFO |
| 结束 RSS | 163.78 MiB | 信息 | INFO |
| 峰值 RSS | 166.52 MiB | 信息 | INFO |
| 预热后 RSS 增长 | 8.45 MiB | <=96.00 MiB | PASS |
| wall time | 0.236s | <=30.0s | PASS |
